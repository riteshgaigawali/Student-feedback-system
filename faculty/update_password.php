...
<form method="post">
	...
	<div class="row" style="margin-top:10px">
		...
		<input type="submit" value="Update Password" name="save" class="btn btn-success" style="background:#4F5B93; border-color: #4F5B93"/>
		<input type="reset" class="btn btn-success" style="background:#4F5B93; border-color: #4F5B93"/>
		</div>
	</div>
</form>	