    ...
    <div class="container-fluid">
      ...
      <div class="row placeholders">
            <div class="col-xs-6 col-sm-3 placeholder">
              <img src="..\images\images_round\Uday_Samant.jpg" width="200" height="200" class="img-responsive" alt="Generic placeholder thumbnail">
              <h4>Shri. Uday Samant,</h4>
              <span class="text-muted">Hon'ble Minister, Higher & Technical Education, (M.S.)</span>
            </div>
            <div class="col-xs-6 col-sm-3 placeholder">
              <img src="..\images\images_round\OPGupta.jpeg" width="200" height="200" class="img-responsive" alt="Generic placeholder thumbnail">
              <h4>Mr. O.P.Gupta,</h4>
              <span class="text-muted">Principal Secretory, Higher & Technical Department, M.S.Mumbai</span>
            </div>
            <div class="col-xs-6 col-sm-3 placeholder">
              <img src="..\images\images_round\director.jpg" width="200" height="200" class="img-responsive" alt="Generic placeholder thumbnail">
              <h4>Dr. Abhay Wagh,</h4>
              <span class="text-muted">Director, Higher & Technical Edu. Department, , M.S.Mumbai</span>
            </div>
          </div>
<?php } ?>
