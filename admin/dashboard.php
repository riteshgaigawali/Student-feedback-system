...
<body>
    ...
    <div id="wrapper">
        ...
        <!-- Navigation -->
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0; background:#4F5B93">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="dashboard.php" style="color:#ffffff">Student Review System</a>
            </div>
            <!-- /.navbar-header -->
            ...
            <ul class="nav navbar-top-links navbar-right">
                <!-- /.dropdown -->
                <li class="dropdown">
                    <a class="dropdown-toggle" data-toggle="dropdown" href="#" style="background:#d3dce4">
            ...
            <div class="navbar-default sidebar" role="navigation" style="background:#4F5B93">
