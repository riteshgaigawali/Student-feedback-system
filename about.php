    ...
    <!-- Navigation -->
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header" align="center"><font color="#00FF33">ONLINE STUDENT REVIEW SYSTEM</font> </h1>
        ...
        <div class="row" style="margin-bottom:50px;margin-left:50px">
               ...
               <P>Student Review System for Govt. Polytecnic Khamgaon in PHP(SOurce code) 
Here we have developed the a student review system, which is generally used in the college to rate the faculty based on the performance...Here we have 2 modules such as administrator, student.
